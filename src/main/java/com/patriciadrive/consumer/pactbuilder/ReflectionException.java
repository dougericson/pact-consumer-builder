...
import static com.patriciadrive.consumer.pactbuilder.Properties.asString;
...
public class ReflectionException extends RuntimeException {
  ...
  static ReflectionException invocationTarget(PropertyDescriptor property, InvocationTargetException e) {
    ...
    return new ReflectionException(
        String.format("An access method for property %s threw an exception.", Properties.asString(property)), e);
  }
